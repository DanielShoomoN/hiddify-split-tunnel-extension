...
func (e *HiddifySplitTunnelExtension) GetUI() ui.Form {
...
func (e *HiddifySplitTunnelExtension) setFormData(data map[string]string) error {
...
func (e *HiddifySplitTunnelExtension) getRunningUI() ui.Form {

	return ui.Form{
		Title:       "hiddify-split-tunnel-extension",
		Description: "Awesome Extension hiddify_split_tunnel_extension created by DanielShoomoN",
		Fields: [][]ui.FormField{
			{{
...
func (e *HiddifySplitTunnelExtension) getStoppedUI() ui.Form {
	// Inital page
	return ui.Form{
		Title:       "hiddify-split-tunnel-extension",
		Description: "Awesome Extension hiddify_split_tunnel_extension created by DanielShoomoN",
...
func (e *HiddifySplitTunnelExtension) addAndUpdateConsole(message ...any) {
